  ...
  <body>
    ...
    <section class="section-hero">  
        ...
        <div class="hero container">
          <div class="hero-img-box">
            <img
                src="./img/group-of-doctors-walking-in-corridor.jpg"  
            ...
            <div class="hero-text-box">
              ...
              <p class="hero-description">
                Medical centers in Albania have built a reputation for being outstanding in the teeth and hair implant treatments.
              </p>
    ...
    <section class="describe-section">  
        <div class="story__pictures">
          <img
            src="img/business-meeting-woman-and-happy-with-laptop-wor-2023-09-01-22-19-36-utc 1.jpg"
            alt="business-meeting-woman-and-happy-with-laptop"
            class="hero-img queris-margin-left medium-width"
          />
        </div>    
